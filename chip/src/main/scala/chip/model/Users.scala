...
import UsersEvents.{AddUser, UsersEvent}
...
object UsersEvents {
  ...
  object UsersEvent {
    ...
    implicit val eventTypableUsersEvent: EventTypable[UsersEvent] =
      new EventTypable[UsersEvent] {
        def eventType(e: UsersEvent): EventType = tag[EventTypeTag][String]("Users")
      }
