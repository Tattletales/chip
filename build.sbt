...
lazy val gossipServer =
  (project in file("gossipServer")).settings(commonSettings).dependsOn(backend)

lazy val streamz =
  ProjectRef(uri("git://github.com/notxcain/streamz.git#abstract-effect"), "converter")
